        ...
        <div class="panel panel-default">  
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input type="password" class="form-control" id="Passwordlama" placeholder="Password">
            </div>
          </div>
          <div class="form-group row">
            <label for="Passwordbaru" class="col-sm-2 col-form-label">Password Baru</label>
            <div class="col-sm-3">
              <input type="password" class="form-control" id="Passwordbaru" placeholder="Password">
            </div>
          </div>
          </div>
